document.addEventListener("DOMContentLoaded", function () {
  ...
  var projectVisuals = [
    ...
    '<div class="project-visual visual-linkedin" role="img" aria-label="Animated LinkedIn profile scraping and connection automation"><div class="visual-top"><span>AUTOMATION / BOT</span><b>RUNNING</b></div><div class="linkedin-stack"><i class="profile-card c1"></i><i class="profile-card c2"></i><i class="profile-card c3"></i><span class="scan-line"></span></div><div class="visual-footer"><span>SELENIUM</span><span>BEAUTIFULSOUP</span></div></div>',
    '<div class="project-visual visual-satellite" role="img" aria-label="Animated satellite land-cover classification grid"><div class="visual-top"><span>EUROSAT / RESNET18</span><b>CLASSIFYING</b></div><div class="sat-grid"><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i></div><div class="visual-footer"><span>TRANSFER LEARNING</span><span>ROC / CM</span></div></div>'
  ];
